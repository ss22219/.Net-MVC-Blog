...
namespace Blog.Domain
{
    ...
    public class ArticleService : IArticleService
    {
        ...
        public PageInfo<Model.Article> FindArticleByMonth(DateTime month, int pageIndex)
        {
            ...
            PageInfo<Article> articles = (PageInfo<Article>)HttpRuntime.Cache.Get("Article_month" + month + "_" + pageIndex);
            if (articles != null)
                return articles;
            int pageSize = int.Parse(_settingService.GetSetting("ArticlePageSize"));
        ...
        {
            IList<Article> LastBlog = (IList<Article>)HttpRuntime.Cache.Get("Article_LastBlog");
            if (LastBlog != null)
            {
                return LastBlog;
            }
        ...
        public PageInfo<Article> FindArticlesByQuery(Func<IQueryable<Article>, IQueryable<Article>> expr, int pageIndex, int pageSize)
        {
            ...
            PageInfo<Article> info = new PageInfo<Article>() { PageIndex = pageIndex, PageSize = pageSize, TotalItem = count };
